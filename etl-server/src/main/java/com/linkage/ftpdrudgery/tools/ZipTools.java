...
public class ZipTools {
	...
	private static ZipTools SINGLE = new ZipTools();
	
	public static synchronized ZipTools getInstance() {
	...
	public static void main(String[] args) throws IOException {
		...
		//ZipTools.getInstance().zip("D:/ziptest", "d:/ziptest.zip");
		ZipTools.getInstance().zip("D://tmp", "d:/ziptest.zip");
	}
